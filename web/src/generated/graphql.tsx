...
export type MutationChangePasswordArgs = {
  newPasswordCopy: Scalars['String'];
...
export type RegularUserFragment = (
  { __typename?: 'User' }
  & Pick<User, '_id' | 'username' | 'updatedAt' | 'createdAt' | 'email'>
);
...
export type BooksQuery = (
  ...
  & { books: Array<(
    { __typename?: 'Book' }
    & Pick<Book, '_id' | 'title' | 'updatedAt' | 'createdAt'>
  )> }
);
...
export const ChangePasswordDocument = gql`
    mutation ChangePassword($token: String!, $newPassword: String!, $newPasswordCopy: String!) {
  changePassword(
    token: $token
